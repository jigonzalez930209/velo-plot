...
```typescript
import { setGlobalLocale, getGlobalLocale } from 'velo-plot/plugins/i18n';
...
```typescript
import { createLocaleFormatter } from 'velo-plot/plugins/i18n';
...
```typescript
import { registerLocale } from 'velo-plot/plugins/i18n';
